...
function sum(a, b) { //eslint-disable-line
    var sum=a+b;
    var result=[sum,'The sum of '+a+ ' and '+b+' is ' +sum +'.'];
    console.log(result);
    return result;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sum=a+b+c;
    var mul=a*b*c;
    var result=[sum,mul,a+' and '+b+' and '+c+' sum to '+sum+'.','The product of '+a+ ' and '+b+' and '+c+' is ' +mul +'.'];
    console.log(result);
    return result;
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var result=[sum,sumArr[0]+','+sumArr[1]+','+sumArr[2]+' was passed in as an array of numbers, and '+sum+' is their sum.'];
    console.log(result);
    return result;
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    var result=[mul,'The numbers '+multArr[0]+','+multArr[1]+','+multArr[2]+' have a product of '+mul+'.'];
    console.log(result);
    return result;
...
that EXACTLY follows this example and concatenates a message using the arguments that were passed 
into the function:
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var mul=multiply(dynamicArray[0],dynamicArray[1])[0];
    var numMsg=dynamicArray[0]+','+dynamicArray[1]+',';

    for(var i=2; i<dynamicArray.length;i++){
        mul=multiply(mul,dynamicArray[i])[0];
        if(i<dynamicArray.length-1){
        numMsg=numMsg+dynamicArray[i]+',';
        }else{
            numMsg=numMsg+dynamicArray[i];
        }
    }  
    return [mul,'The numbers '+numMsg+' have a product of '+mul+'.'];
}
